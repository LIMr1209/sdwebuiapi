...
class WebUIApi:
    ...
    def _to_api_result(self, response):
        ...
        if 'images' in r.keys():
            ...
            r["caption"].pop("general")
            r["caption"].pop("sensitive")
            r["caption"].pop("questionable")
            r["caption"].pop("explicit")
    ...
    def img2text(self,
        ...
        response = self.session.post(url=f'{self.baseurl}/tagger/v1/interrogate', json=payload)
        return self._to_api_result(response)
